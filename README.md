...
Проект содержит динамический датакаталог  **[data_catalog.csv](data_catalog.csv)** , который автоматически собирает и обновляет информацию обо всех файлах в папке data/.
